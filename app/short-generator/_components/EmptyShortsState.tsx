...
export default function EmptyShortsState() {
  return (
    <div className="ec-root">
      ...
      <div className="ec-main" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="ec-title-wrap">
          ...
          {/* Title */}
          <h2 className="ec-title">Silent Stage, Loud Ideas</h2>
        </div>

        {/* Subtext */}
        <p className="ec-subtext">
          Create your first short video series by entering a <span className="ec-tag">topic</span> above and
          letting Migoo <span className="ec-tag">generate</span> viral shorts for you instantly.
        </p>

        {/* Navigation Cards */}
        <div className="ec-cards">

          {/* Card 1 — Create New Series */}
          <Link href="/short-generator/create" className="ec-card">
            <div className="ec-card-left">
              ...
              <div className="ec-card-text">
                <div className="ec-card-title">Create First Series</div>
                <div className="ec-card-sub">Generate viral short content instantly...</div>
              </div>
            </div>
            <span className="ec-card-arrow">›</span>
          </Link>

          {/* Card 2 — Go to Courses */}
