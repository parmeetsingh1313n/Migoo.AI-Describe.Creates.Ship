  ...
  return (
    <div className="ec-root">
      ...
      <div className="ec-main" style={{ position: 'relative', zIndex: 1 }}>
        ...
        {/* Lost text */}
        <p className="ec-lost">Seems you&apos;ve wandered off...</p>
        ...
        <div className="ec-title-wrap">
          ...
          {/* Title */}
          <h2 className="ec-title">Whoops! Nothing here yet</h2>
        </div>

        {/* Subtext */}
        <p className="ec-subtext">
          Generate your first course by entering a <span className="ec-tag">topic</span> above and
          letting Migoo <span className="ec-tag">create</span> a complete cinematic
          video course for you instantly.
        </p>

        {/* Navigation Cards */}
        <div className="ec-cards">

          {/* Card 1 — Generate Course */}
            ...
            <div className="ec-card-left">
              <div className="ec-card-icon">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <path d="M9 21V12h6v9" stroke="white" fill="white"/>
                </svg>
              </div>
              <div className="ec-card-text">
                <div className="ec-card-title">Create First Course</div>
                <div className="ec-card-sub">Back where it all begins...</div>
              </div>
            </div>
          ...
          {/* Card 2 — Try Shorts */}
          <Link href="/short-generator" className="ec-card">
            <div className="ec-card-left">
              <div className="ec-card-icon">
              ...
              <div className="ec-card-text">
                <div className="ec-card-title">Try Viral Shorts</div>
                <div className="ec-card-sub">Where we walk the walk</div>
              </div>
            </div>
            <span className="ec-card-arrow">›</span>
          </Link>
