...
async function startLocalRender(chapterId: string, slides: any[], durationsBySlideId: Record<string, number>, fps: number, outputPath: string) {
...
export async function POST(req: NextRequest) {
  ...
  const fps = 30;
  startLocalRender(chapterId, slides, durationsBySlideId, fps, localOutputPath).catch(err => {
