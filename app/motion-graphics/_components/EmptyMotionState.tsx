...
export default function EmptyMotionState() {
  const handleScrollToPrompt = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    const element = document.getElementById('motion-graphic-prompt');
    if (element) {
    ...
    <div className="ec-root">
      ...
      <div className="ec-main" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="ec-title-wrap">
          ...
          {/* Title */}
          <h2 className="ec-title">The Canvas is Yours</h2>
        </div>

        {/* Subtext */}
        <p className="ec-subtext">
          Create your first motion graphic by entering a <span className="ec-tag">description</span> above and
          letting Migoo <span className="ec-tag">generate</span> a premium customized cinematic video animation instantly.
        </p>

        {/* Navigation Cards */}
        <div className="ec-cards">

          {/* Card 1 — Create New Motion Graphic */}
          <a href="#motion-graphic-prompt" onClick={handleScrollToPrompt} className="ec-card">
            <div className="ec-card-left">
              ...
              <div className="ec-card-text">
                ...
                <div className="ec-card-sub">Describe your video ideas above...</div>
              </div>
            </div>
