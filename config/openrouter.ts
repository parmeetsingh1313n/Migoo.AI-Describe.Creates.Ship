...
7. IMAGES ARE BOUNDED SIDE ELEMENTS: An image goes ONLY in a ~40% side column of a 2-column body, with the <img> at width:100%;height:100%;max-height:440px;object-fit:cover (the img max-height is the ONLY height cap allowed). NEVER a full-width/centered square image, and NEVER an image stacked under the headline.
