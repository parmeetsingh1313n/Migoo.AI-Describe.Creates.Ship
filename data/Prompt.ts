...
// ═══════════════════════════════════════════════════════════════════════════════
// CHAPTER PLANNING PROMPT (for parallel slide generation)
// ═══════════════════════════════════════════════════════════════════════════════
...
2. Code budget: Exactly codeBudget slides should have isCodeSlide=true and use a CODE archetype (CODE SNIPPET, CODE + EXPLAIN, CODE + CALLOUTS, CODE + STEPS, CODE + COMPANION). The rest use non-code archetypes. Pick code slides for topics that genuinely need a syntax example.
...
4. Flow context: Each slide's contextNote briefly states what the prior slide covered and what the next will cover, so the slide's narration flows naturally (e.g. "Building on the loop syntax from slide 3, this slide shows...").
